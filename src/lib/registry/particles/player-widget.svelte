<script lang="ts">
	import * as AudioPlayer from "$registry/ui/audio/player/index";
	import * as AudioTrack from "$registry/ui/audio/track/index.js";
	import * as AudioQueue from "$registry/ui/audio/queue/index.js";
</script>

<AudioPlayer.Root class="flex flex-col gap-1.5">
	<AudioTrack.List class="bg-muted/50 h-36 w-full rounded-sm border p-1" />
