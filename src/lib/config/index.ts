export const siteConfig = {
	...
	title:
		'Svelte Audio UI — Build accessible Svelte audio interfaces fast with composable Audio UI components. Copy, paste, and own. Explore docs and ready-made components.',
